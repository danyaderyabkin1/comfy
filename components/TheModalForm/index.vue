  ...
  <div class="modal__container">
    ...
    <form @submit.prevent="sendForm" class="flex flex-col w-full">
      ...
      <UCheckbox color="gray" class="my-3" v-model="checkbox">
        <template #label>
          <span class="text-gray-600">Я даю согласие на обработку моих персональных данных ООО «» (ИНН ) в целях обработки заявки и обратной связи. <router-link class="text-gray-500" target="_blank" to="/assets/policyO.pdf">Политика конфиденциальности</router-link> </span>
        </template>
      </UCheckbox>
