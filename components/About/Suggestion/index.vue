...
const {data} = await useAsyncData(() => $fetch(`https://wecrm.ru/api/buildForm/24`))
...
<template>
  <section :class="{pink: bgColor}" class="suggestion">
    <div class="container">
      <h3 class="title w:md-3/5 mx-auto mb-8" v-html="title"></h3>
      <form @submit.prevent="sendForm" class="w-full max-w-md mx-auto">
        ...
        <div class="md:flex  md:items-center justify-center mb-3 mt-5">
      ...
      <div class="max-w-md mx-auto relative pb-7">
