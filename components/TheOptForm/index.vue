          ...
          <div class="w-full flex flex-wrap md:gap-3">
            <div class="md:flex w-full md:w-2/5 md:items-center justify-center mb-4">
              <div class="w-full">
                ...
                <input
                    class="bg-gray-100 appearance-none border-2 border-gray-100 rounded-3xl w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-gray-300"
                    id="inline-full-name"
